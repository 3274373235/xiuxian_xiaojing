...
async def get_boss_battle_info(user_info, rift_rank, bot_id):
    ...
    if victor == "群友赢了":  # 获胜
        ...
        give_stone = 25000000 if (rift_rank + user_rank) * success_info["give"]["stone"] < 0 else (rift_rank + user_rank) * success_info["give"]["stone"]
